...
def paged_attention(
    ...
    print("input_metadata.block_tables:",block_tables)
    #print("override_context_lens:",override_context_lens)
    print("input_metadata.context_lens:",context_lens)
    print("block_size:",block_size)
    #print("override_max_context_len:",override_max_context_len)
    print("input_metadata.max_context_len:",max_context_len)
    print("alibi_slopes:",alibi_slopes)
    #print("apply_attn_bias:",apply_attn_bias)
    print("attn_bias:",custom_bias)
    print("input_metadata.kv_cache_dtype:",kv_cache_dtype)
